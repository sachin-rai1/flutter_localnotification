...
class Themes {
  static final lightTheme = ThemeData(primarySwatch: Colors.blue , backgroundColor: Colors.white , brightness: Brightness.light);

  static final darkTheme = ThemeData(primarySwatch: Colors.blueGrey, backgroundColor: Colors.white12 , brightness: Brightness.dark);
}
